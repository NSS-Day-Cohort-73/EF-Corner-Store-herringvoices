...
namespace CornerStore.Migrations
{
    ...
    [Migration("20250117224512_ReSeed")]
            ...
            modelBuilder.Entity("CornerStore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierId = 1,
                            PaidOnDate = new DateTime(2025, 1, 17, 16, 45, 12, 253, DateTimeKind.Local).AddTicks(7910)
                        },
                        new
                        {
                            Id = 2,
                            CashierId = 2,
                            PaidOnDate = new DateTime(2025, 1, 17, 16, 45, 12, 253, DateTimeKind.Local).AddTicks(7964)
                        });
                });
